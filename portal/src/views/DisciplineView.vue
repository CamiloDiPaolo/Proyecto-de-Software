    ...
    <div class="grid grid-cols-1 gap-10 xl:grid-cols-2">
      ...
      >
        <p class="font-normal text-left text-gray-300 dark:text-gray-400">
          <span class="font-normal text-left text-[#8D72E1] text-gray-300 dark:text-gray-400">Costo:</span>
          {{discipline.costo}}
        </p>
        <p class="font-normal text-gray-300 dark:text-gray-400">
          <span class="font-normal text-[#8D72E1] text-gray-300 dark:text-gray-400">Instructores:</span>
          {{discipline.instructores}}
        </p>
        <p class="font-normal text-gray-300 dark:text-gray-400">
          <span class="font-normal text-[#8D72E1] text-gray-300 dark:text-gray-400">Horarios:</span>
          {{discipline.horarios}}
        </p>
        <p class="font-normal text-gray-300 dark:text-gray-400">
          <span class="font-normal text-[#8D72E1] text-gray-300 dark:text-gray-400">Categoría:</span>
